...
import controllers.app.AppCityController;
...
import controllers.app.AppMyProjectController;
...
public class EedaConfig extends JFinalConfig {
    ...
    private void setAppRoute(Routes me) {
        ...
        me.add("/app/category", AppCategoryController.class);
        ...
        me.add("/app/myProject", AppMyProjectController.class);
        me.add("/app/city", AppCityController.class);
    }
