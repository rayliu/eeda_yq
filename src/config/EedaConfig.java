...
import controllers.oms.bookingOrder.BookingOrderController;
...
import controllers.tms.dispatch.VehicleStatusController;
...
//		me.add("/report", ReportController.class, contentPath);
		...
		me.add("/vehicleStatus", VehicleStatusController.class, contentPath);
        ...
        me.add("/outputScale", controllers.tms.arap.outputScaleController.class, contentPath);
...
//        me.add("/costConfirm", controllers.arap.ap.CostConfirmController.class, contentPath);
        ...
        me.add("/totalProfit",controllers.arap.TotalProfitController.class, contentPath);
        
        me.add("/manualReport",controllers.arap.ManualReportController.class, contentPath);
...
//        arp.addMapping("contact", Contact.class);       
        ...
        arp.addMapping("request_invoices", RequestInvoices.class);
