    ...
    public void list() {
        ...
        if(checked!=null&&!"".equals(checked)&&checked.equals("Y")){
   		 sql = "select * from(  "
				 ...
				 +" iF(cpoa.charge_id=164,cpoa.total_amount,null) MTF, "
				 +" iF(cpoa.charge_id=165,cpoa.total_amount,null) YJ, "
				 +" iF(cpoa.charge_id=166,cpoa.total_amount,null) ZHF, "
				 +" iF(cpoa.charge_id=167,cpoa.total_amount,null ) GKF, "
				 +" iF(cpoa.charge_id=168,cpoa.total_amount,null) LHF, "
				 +" iF(cpoa.charge_id=169,cpoa.total_amount,null) SCF, "
				 +" iF(cpoa.charge_id=175,cpoa.total_amount,null) ZLSCF, "
				 +" iF(cpoa.charge_id=176,cpoa.total_amount,null) FTF, "
				 +" iF(cpoa.charge_id=177,cpoa.total_amount,null) PZF, "
				 +" iF(cpoa.charge_id=178,cpoa.total_amount,null) XDF, "
				 +" iF(cpoa.charge_id=179,cpoa.total_amount,null) WLDLF, "
				 +" iF(cpoa.charge_id=180,cpoa.total_amount,null) LXF, "
				 +" iF(cpoa.charge_id=181,cpoa.total_amount,null) AC,  "
				 +" iF(cpoa.charge_id=182,cpoa.total_amount,null) WJF, "
				 +" iF(cpoa.charge_id=183,cpoa.total_amount,null) RZF,  "
				 +" iF(cpoa.charge_id=184,cpoa.total_amount,null) YF, "
				 +" iF(cpoa.charge_id=185,cpoa.total_amount,null) BGF, "
				 +" iF(cpoa.charge_id=186,cpoa.total_amount,null) DTF "
