...
public class ProfitAndPaymentRateController extends Controller {
	...
	public void listTotal() {
		...
		String sql=" SELECT "
			...
			+"	  WHERE 1=1 and (jo.office_id="+office_id+ ref_office+ ") and joa.currency_id = 3 "
			...
			+"	  LEFT JOIN job_order_arap joa on jo.id = joa.order_id "
			+"	  LEFT JOIN party p on p.id = jo.customer_id"
			+"	  WHERE 1=1 and (jo.office_id="+office_id+ ref_office+ ") and joa.currency_id = 6 "
			+"	  and joa.order_type = 'charge' "+condition
			+ " and jo.delete_flag = 'N'"
			+"	) charge_usd,"
			+"	(SELECT "
			...
			+"	  LEFT JOIN job_order_arap joa on jo.id = joa.order_id "
			+"	  LEFT JOIN party p on p.id = jo.customer_id"
			+"	  WHERE 1=1 and (jo.office_id="+office_id+ ref_office+ ") and joa.currency_id = 8 "
			+"	  and joa.order_type = 'charge' "+condition
			+ " and jo.delete_flag = 'N'"
			+"	) charge_jpy,"
			+"	(SELECT "
			...
			+"	  LEFT JOIN job_order_arap joa on jo.id = joa.order_id "
			+"	  LEFT JOIN party p on p.id = jo.customer_id"
			+"	  WHERE 1=1 and (jo.office_id="+office_id+ ref_office+ ") and joa.currency_id = 9 "
			+"	  and joa.order_type = 'charge' "+condition
			+ " and jo.delete_flag = 'N'"
			+"	) charge_hkd,"
			+"	(SELECT "
