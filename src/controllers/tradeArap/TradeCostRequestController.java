...
public class TradeCostRequestController extends Controller {
    private Log logger = Log.getLog(TradeCostRequestController.class);
    ...
    @Before(EedaMenuInterceptor.class) 
    public void create() {
		render("/tradeArap/CostRequest/create.html");
	}
    ...
    public void billDetailed() {
		...
		render("/tradeArap/CostRequest/costEdit_select_item.html");
	}
...
//	        }
		  ...
		  Db.update(ySql);
   		...
   		SysInfoController.saveLog(jsonStr, id, user, action_type, "付款申请单", "trade");
  	...
  	public void edit() throws ParseException {
		...
		render("/tradeArap/CostRequest/costEdit.html");
	}
