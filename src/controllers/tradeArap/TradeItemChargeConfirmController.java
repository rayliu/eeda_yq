...
public class TradeItemChargeConfirmController extends Controller {
	private Logger logger = Logger.getLogger(TradeItemChargeConfirmController.class);
	...
	public void index() {
		...
		List<Record> configList = ListConfigController.getConfig(user_id, "/tradeItemChargeConfirmList");
        setAttr("listConfigList", configList);
		render("/tradeArap/ItemChargeConfirm/list.html");
	}
	...
	public void list() {
        ...
        String sql = "SELECT*FROM(SELECT tjoa.*,tjo.order_no,tjo.order_export_date,tjo.create_stamp,tjo.customer_id,"
        		   ...
        		   + " WHERE tjoa.order_type = 'charge' and (tjo.office_id = "+office_id + ref_office+")"
