...
public class TransChargeConfirmController extends Controller {
    ...
    public void list() {
        ...
        String sql = "select * from( "
        		...
        		+ " CONVERT(substring(REPLACE(GROUP_CONCAT(IF(unload_type!='移柜' and unload_type!='收重柜',tjol.cabinet_date,'')),',',''), 1, 11),char) cabinet_date,p.company_name customer,p1.company_name sp_name,f.name charge_name,u.name unit_name,c.name currency_name "
