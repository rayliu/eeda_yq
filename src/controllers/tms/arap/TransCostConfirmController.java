...
public class TransCostConfirmController extends Controller {

	private Logger logger = Logger.getLogger(TransCostConfirmController.class);
	Subject currentUser = SecurityUtils.getSubject();
	private Object type;

	@Before(EedaMenuInterceptor.class)
	public void index() {
		render("/tms/arap/transCostConfirm/transCostConfirm.html");
	}
