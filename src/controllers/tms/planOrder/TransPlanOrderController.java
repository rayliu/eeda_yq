package controllers.tms.planOrder;
...
public class TransPlanOrderController extends Controller {

	private Logger logger = Logger.getLogger(TransPlanOrderController.class);
