...
//        }
    ...
    private void handleCustomSearch(Map<String, ?> dto, Long form_id){
        CustomSearchService css = new CustomSearchService();
        css.handleCustomSearch(dto, form_id);
    }
    ...
    public void searchFormBtnEvents() {
        ...
        switch(name) {
            ...
            case "选中行":
                ...
                break;
            case "取消选中行":
                list = Db.find("select * from eeda_form_event where form_id=? and type='list_event_unmark_row'",
                        form_id);
                break;
            default:
