...
public class EbayAccountController extends Controller {
    ...
    public void list() {
        ...
        String sql = "select * from seller_account where type='"+EbayApiContextUtil.configStr+"' and office_id = "+ user.getLong("office_id");
    ...
    public void auth_accepted(){
        ...
        try {
            ...
            Record rec = Db.findFirst("select * from seller_account where account_name='"+user_name+"'");
            if(rec !=null){
