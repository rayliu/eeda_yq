...
public class TradeProfitAndPaymentRateController extends Controller {
	private Log logger = Log.getLog(TradeProfitAndPaymentRateController.class);
	...
	public void index() {
		...
		List<Record> configList = ListConfigController.getConfig(user_id, "/tradeProfitAndPaymentRate");
        setAttr("listConfigList", configList);
		render("/tr/tradeReport/tradeProfitAndPaymentRate.html");
	}
