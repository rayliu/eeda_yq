...
public class BookingChargeBalanceReportController extends Controller {
	private Log logger = Log.getLog(BookingChargeBalanceReportController.class);
	...
	public void index() {
		...
		List<Record> configList = ListConfigController.getConfig(user_id, "/bookingChargeBalanceReport");
        setAttr("listConfigList", configList);
		render("/eeda/bookingReport/bookingChargeBalanceReport.html");
	}
