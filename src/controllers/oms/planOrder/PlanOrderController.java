    ...
    public void list() {
        ...
        if("todo".equals(type)){
        	...
        	sql = "SELECT * from (select"
        			...
        			+ " IFNULL(if((poi.CARRIER is not null or poi.VESSEL is not null or poi.VOYAGE is not null)and poi.confirm_shipment = 'N',' <span style=\"color:green;\">已定仓</span>',null),IF (poi.confirm_shipment = 'Y',' 已确认出货',' 新建'))) SEPARATOR '<br/>')) item_status,"
