...
//        SimpleDateFormat format = new SimpleDateFormat("yyyyMMddHHmmssSSS");
	...
	public void printTotaledReceiveDetailPDF(){
		...
		if("昂励制冷器材(中山)有限公司".equals(company_name)||"昂励制冷器材（中山）有限公司".equals(company_name)){
			 fileName = "/report/checkOrder/SpecialTotaledReceivableDetails.jasper";
		}else if("昂励制冷设备（上海）有限公司".equals(company_name)||"昂励制冷设备(上海)有限公司".equals(company_name)){
