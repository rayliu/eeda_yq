define(['jquery', 'metisMenu', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco'], function ($, metisMenu) { 
  ...
  $(document).ready(function() {
  		 ...
  		 //添加
  		 $('#addpickup_van_item').click(function(){
  				$('#pickup_van_table tbody').append('<tr>'+'<td><button type="button" class="btn table_btn delete_btn btn-xs">'
  		 ...
  		 //删除
  		 $("#pickup_van_table").on('click', '.delete_btn', function(e){
