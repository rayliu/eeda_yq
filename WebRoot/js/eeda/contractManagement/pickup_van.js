define(['jquery', 'metisMenu', 'template', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco', 'jq_blockui'], function ($, metisMenu, template) { 
	$(document).ready(function() {
	    ...
	    //删除一行
	    $("#pickup_van_table").on('click', '.delete', function(e){
	        e.preventDefault();
	    ...
	    itemOrder.buildPickupVanDetail=function(){
	    	var cargo_table_rows = $("#pickup_van_table tr");
	    ...
	    $('#addpickup_van_item').on('click', function(){
	        var item={};
	        cargoTable.row.add(item).draw(true);
	    });
	    
	    //刷新明细表
	    itemOrder.refleshPickupVanTable = function(order_id){
	    	var url = "/supplierContract/tableList?order_id="+order_id+"&type=pickingCrane";
