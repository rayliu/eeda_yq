define(['jquery', 'metisMenu', 'template', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco', 'jq_blockui'], function ($, metisMenu, template) { 
	$(document).ready(function() {
	    ...
	    //删除一行
	    $("#air_transport_table").on('click', '.delete', function(e){
	        e.preventDefault();
	    ...
	    itemOrder.buildAirTransportDetail=function(){
	    	var cargo_table_rows = $("#air_transport_table tr");
	    ...
	    $('#add_air_transport').on('click', function(){
	        var item={};
	        cargoTable.row.add(item).draw(true);
	    });
	    
	    //刷新明细表
	    itemOrder.refleshAirTransportTable = function(order_id){
	    	var url = "/supplierContract/tableList?order_id="+order_id+"&type=airTransport";
