define(['jquery', 'metisMenu', 'template', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco', 'jq_blockui'], function ($, metisMenu, template) { 
	$(document).ready(function() {
	    ...
	    itemOrder.buildInternalTradeDetail=function(){
...
//	    	});
	    ...
	    //刷新明细表
	    itemOrder.refleshInternalTradeTable = function(order_id){
	    	var url = "/supplierContract/tableList?order_id="+order_id+"&type=internalTrade";
