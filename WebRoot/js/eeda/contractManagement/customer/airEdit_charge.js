...
$(document).ready(function() {
    ...
    itemOrder.buildAirItem=function(){
        var cargo_table_rows = $("#charge_air_table tr");
    ...
    var bindFieldEvent=function(){
        ...
        eeda.bindTableField('charge_air_table','POL_ID','/location/searchPort','air_port');
        eeda.bindTableField('charge_air_table','POD_ID','/location/searchPort','air_port');
