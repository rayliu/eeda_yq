define(['jquery', 'metisMenu', 'template', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco'], function ($, metisMenu, template) {
    $(document).ready(function() {
        ...
        itemOrder.refleshAirItemTable = function(contract_id){
        	var url = "/customerContract/tableList?contract_id="+contract_id+"&type=air";
        ...
        itemOrder.refleshAirLocTable = function(contract_id){
        	var url = "/customerContract/tableList?contract_id="+contract_id+"&type=air_loc";
        ...
        $('#air_location_table').on('click','[name=checkRoute]', function(){
        	var self = this;
            ...
            var url = "/customerContract/clickItem?contract_id="+order_id+"&type=air&customer_loc_id="+item_id;
        	cargoTable.ajax.url(url).load();
        });
    });
