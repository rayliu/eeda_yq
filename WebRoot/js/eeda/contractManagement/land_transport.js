define(['jquery', 'metisMenu', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco'], function ($, metisMenu) { 
  ...
  $(document).ready(function() {
	  ...
	  var deletedTableIds=[];
	  itemOrder.buildLandTransportDetail=function(){
	    	var cargo_table_rows = $("#land_transport_table tr");
	    ...
	    var cargoTable = eeda.dt({
          ...
          columns:[
  		 ...
  		 $('#addland_transport').on('click', function(){
 	        var item={};
  		 ...
  		 //删除一行
 	    $("#land_transport_table").on('click', '.delete', function(e){
 	        e.preventDefault();
 	    ...
 	    //刷新明细表
 	   itemOrder.refleshLandTransportTable = function(order_id){
 	    	var url = "/supplierContract/tableList?order_id="+order_id+"&type=landTransport";
