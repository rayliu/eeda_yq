...
$(document).ready(function() {
    ...
    //------------事件处理
	 var cargoTable = eeda.dt({
            ...
            { "data": "DRIVER_TEL", "width": "70px",
                "render": function ( data, type, full, meta ) {
                    if(!data)
                        data='';
                    return '<input type="text" name="driver_tel" value="'+data+'" class="form-control phone" style="width:90px" />';
                }
            },
            ...
            { "data": "DISPATCH_DATE", "width": "100px",
            	"render": function ( data, type, full, meta ) {
            		var info = "";
            		if(!data)
                        data='';
            ...
            { "data": "SIGN_STATUS", "width": "140px",
            	"render": function ( data, type, full, meta ) {
            		if(!data)
            			data='';
            		return '<input type="text" name="sign_status" value="'+data+'" class="form-control" style="width:160px"/>';
            	}
            },
            { "data":"ID","width": "50px",
            	"render": function ( data, type, full, meta ) {
