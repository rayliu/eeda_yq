...
//    var costRMB = $('[name=costRMB]').text();    		
    ...
    //校验
    $('#cost_table').on("blur","[name=price],[name=amount],[name=exchange_rate],[name=street_vehicle_freight],[name=remark]",function(){
		var data = $(this).val();
    ...
    $('#cost_table').on("focus","[name=price],[name=amount],[name=exchange_rate],[name=street_vehicle_freight],[name=remark]",function(){
