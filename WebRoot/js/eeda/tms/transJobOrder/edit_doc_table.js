...
$(document).ready(function() {
    ...
    $("#doc_table").on('click', '.delete', function(e){
        ...
        var id = tr.attr('id');
         ...
         $.post('/transJobOrder/deleteDoc', {docId:id}, function(data){
        	 if(data.result==true){
    ...
    $('#confirmSendBtn').click(function(){
    	...
    	$.post('/transJobOrder/sendMail', {order_id:order_id,mailTitle:title,email:email,ccEmail:ccEmail,bccEmail:bccEmail,mailContent:content,docs:docs.toString()}, function(data){
