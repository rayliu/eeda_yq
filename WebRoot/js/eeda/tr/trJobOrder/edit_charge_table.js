...
$(document).ready(function() {
    ...
    $("#charge_table").on('click', '.chargeConfirm', function(){
    	...
    	$.post('/trJobOrder/feeConfirm',{id:id},function(data){
   ...
   $(function(){
            ...
            { "data": "TYPE", "width": "60px", 
                "render": function ( data, type, full, meta ) {
                	if(full.AUDIT_FLAG == 'Y'){
                		var str = '<select name="type" class="form-control search-control notsave" style="width:60px" disabled>'  
	                	...
	                	return str;
                			...
                			var str = '<select name="type" class="form-control search-control notsave" style="width:60px">'
    ...
    itemOrder.refleshChargeTable = function(order_id){
    	var url = "/trJobOrder/tableList?order_id="+order_id+"&type=charge";
...
//    })
  ...
  //选择是否是同一结算公司
    ...
    //校验
    $('#charge_table').on("blur","[name=price],[name=amount],[name=exchange_rate],[name=exchange_currency_rate],[name=exchange_currency_rate_rmb],"
    ...
    $('#charge_table').on("focus","[name=price],[name=amount],[name=exchange_rate],[name=exchange_currency_rate],[name=exchange_currency_rate_rmb],"
    		+"[name=remark]",function(){
