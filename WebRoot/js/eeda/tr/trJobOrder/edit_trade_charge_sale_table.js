...
$(document).ready(function() {
    ...
    itemOrder.refleshTradeSaleItemTable = function(order_id){
        var url = "/trJobOrder/tableList?order_id="+order_id+"&type=trade_sale";
    ...
    $('#collapseChargeSaleInfo').on('show.bs.collapse', function () {
        ...
        if(order_type.trim() == '' || customer_id == ''){
            ...
            $.post('/trJobOrder/getTradeSaleTemplate', {order_type:order_type,customer_id:customer_id,arap_type:type}, function(data){
                if(data){
    ...
    $('#ChargeSaleDiv').on('click', '.deleteChargeTemplate,.deleteCostTemplate', function(){
        ...
        var id = ul.attr('id');
        $.post('/trJobOrder/deleteTradeSaleTemplate', {id:id}, function(data){
            if(data){
  ...
  //校验
    $('#trade_sale_table').on("blur","[name=price],[name=amount],[name=exchange_rate],[name=exchange_currency_rate],[name=exchange_currency_rate_rmb],"
    ...
    $('#trade_sale_table').on("focus","[name=price],[name=amount],[name=exchange_rate],[name=exchange_currency_rate],[name=exchange_currency_rate_rmb],"
    		+"[name=remark]",function(){
