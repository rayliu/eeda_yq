...
$(document).ready(function() {
    ...
    $("#doc_table").on('click', '.delete', function(e){
        ...
        var id = tr.attr('id');
         ...
         $.post('/trJobOrder/deleteDoc', {docId:id}, function(data){
        	 if(data.result==true){
    ...
    $('#confirmSendBtn').click(function(){
    	...
    	$.post('/trJobOrder/sendMail', {order_id:order_id,mailTitle:title,email:email,ccEmail:ccEmail,bccEmail:bccEmail,mailContent:content,docs:docs.toString()}, function(data){
    ...
    itemOrder.refleshDocTable = function(order_id){
    	var url = "/trJobOrder/tableList?order_id="+order_id+"&type=doc";
    	docTable.ajax.url(url).load();
    }
    
    itemOrder.refleshEmailTable = function(order_id){
    	var url = "/trJobOrder/tableList?order_id="+order_id+"&type=mail";
    ...
    $('#addEmailTemplate').click(function(){
    	...
    	$.post('/trJobOrder/saveEmailTemplate', {email:email,ccEmail:ccEmail,bccEmail:bccEmail,remark:remark}, function(data){
    		if(data.result==true){
    ...
    $('.deleteEmailTemplate').click(function(e) {
    	...
    	var id = li.attr('id');
    	$.post('/trJobOrder/deleteEmailTemplate', {id:id}, function(data){
    		$.scojs_message('删除成功', $.scojs_message.TYPE_OK);
