define(['jquery', 'metisMenu', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco',  'dtColReorder'], function ($, metisMenu) {
  $(document).ready(function() {
      ...
      var dataTable = eeda.dt({
          ...
          ajax: "/tradeChargeBalanceReport/list",
          ...
          columns: [
	            ...
	            { "data": "UNCHARGE_RMB", "width": "120px","class":"uncharge_rmb",
					...
					return '<span style="color:red;">'+eeda.numFormat(data)+'</span>';
				  }
	            },
	            { "width": "50px",
					"render": function(data, type, full, meta) {
	...
	$('#singleSearchBtn').click(function(){
	     ...
	     var url = "/tradeChargeBalanceReport/list?sp_id="+sp_id
	   ...
	   //合计字段
         $.post('tradeChargeBalanceReport/listTotal',{
       	  sp_id:sp_id,
       	  employee_id:employee_id,
       	  order_export_date_begin_time:order_export_date_begin_time,
       	  order_export_date_end_time:order_export_date_end_time
...
//        	  $($('.dataTables_scrollFoot tr')[0]).find('th[class=uncharge_rmb]').html("未收折合(CNY):"+eeda.numFormat(total_uncharge,3)).css('color','red');
          ...
          */
          var url = "/tradeChargeBalanceReport/list?sp="+sp_id
