...
//          ajax: "/profitAndPaymentRate/list",
	...
	$('#singleSearchBtn').click(function(){
     ...
     var searchData=function(){
          ...
          */
          ...
          //合计字段
          $.post('tradeTotalProfit/listTotal',{
        	  customer:customer,
          ...
          var url = "/tradeTotalProfit/list?customer="+customer
         				  +"&abbr_like="+customer_name
				          +"&order_export_date_begin_time="+order_export_date_begin_time
				          +"&order_export_date_end_time="+order_export_date_end_time;
    ...
    //导出excel利润表
      ...
      var excel_method = function(customer_id,begin_time,end_time){
    	  $.post('/tradeTotalProfit/downloadExcelList',{customer:customer_id,begin_time:begin_time,end_time:end_time}, function(data){
