            ...
            columns:[
                ...
                },//return "<a href='/transJobOrder/edit?id="+full.ID+"'target='_blank'>"+data+"</a>";
                {
                    ...
                    "render": function(data, type, full, meta) {
                    	...
                    	if(strType=="应收申请单"){
                    		return "<a href='/tradeChargeRequest/edit?id="+full.INVOICE_ORDER_ID+"'target='_blank'>"+full.ORDER_NO+"</a>";
                    	}
                    	if(strType=="应付申请单"){
                    		return "<a href='/tradeCostRequest/edit?id="+full.INVOICE_ORDER_ID+"'target='_blank'>"+full.ORDER_NO+"</a>";
                    	}
                    }
                },
                {"data":"SOURCE_ORDER"},
