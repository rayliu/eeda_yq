...
var itemIds=[];
        ...
        var refleshSelectTable = function(order_ids, ids){
            ...
            var callback=function(){
            	...
            	var url = "/tradeChargeCheckOrder/tableList?order_ids="+order_ids+"&order_id=N";
        ...
        var searchData2=function(){
            ...
            var url = "/tradeChargeCheckOrder/tableList?order_ids="+ids+"&order_id=N"
                            +"&table_type=item"
     ...
     var searchData3=function(){
      ...
      $('#eeda_charge_table').on('click',"input[name='order_check_box']",function () {
        ...
        var refleshCreateTable = function(appApplication_id){
    		var url = "/tradeChargeCheckOrder/tableList?appApplication_id="+appApplication_id+"&order_id=N&bill_flag=create";
