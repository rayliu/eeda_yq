define(['jquery', 'metisMenu', 'sb_admin',  'dataTablesBootstrap','sco','dtColReorder','validate_cn'], function ($, metisMenu) { 
    ...
    $(document).ready(function() {
        ...
        var dataTable = eeda.dt({
            ...
            ajax: "/bookingCostCheckOrder/checkedList",
            columns:[	                
					  { "data": "ORDER_NO", "width": "100px",
			            	 "render": function ( data, type, full, meta ) {
			           		  return "<a href='/bookingCostCheckOrder/edit?id="+full.ID+"'target='_blank'>"+data+"</a>";
			           	  }
			          },
     ...
     var searchData=function(){
          ...
          */
          var url = "/bookingCostCheckOrder/checkedList?order_no="+order_no
               +"&sp_name="+sp_name
               +"&create_stamp_begin_time="+start_date
               +"&create_stamp_end_time="+end_date
