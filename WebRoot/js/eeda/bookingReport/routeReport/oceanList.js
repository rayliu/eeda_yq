define(['jquery', 'metisMenu', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco', 'dtColReorder'], function ($, metisMenu) {
  $(document).ready(function() {
      ...
      var dataTable = eeda.dt({
          ...
          serverSide: true, 
          pageLength: 25,
          ajax: "/bookingOceanRouteReport/oceanList",
          columns: [
     ...
     var searchData=function(){
        ...
        //合计字段
          $.post('bookingOceanRouteReport/listTotal',{
          ...
          //增加出口日期查询
          var url = "/bookingOceanRouteReport/list?order_no="+order_no
          	    +"&customer_id="+customer_id
          	    +"&date_type="+date_type
    ...
    //导出excel
      $('#exportTotaledExcel').click(function(){
		  ...
		  $.post('/bookingOceanRouteReport/downloadExcelList',{customer_id:customer_id,date_type:date_type,type:type,begin_date:begin_date,end_date:end_date}, function(data){
