define(['jquery', 'metisMenu', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco', 'dtColReorder'], function ($, metisMenu) {
  $(document).ready(function() {
      ...
      var dataTable = eeda.dt({
          ...
          serverSide: true, 
          pageLength: 25,
          ajax: "/bookingAirRouteReport/list",
          columns: [
     ...
     var searchData=function(){
        ...
        //合计字段
          $.post('bookingAirRouteReport/listTotal',{
          ...
          //增加出口日期查询
          var url = "/bookingAirRouteReport/list?order_no="+order_no
          	    +"&customer_id="+customer_id
          	    +"&date_type="+date_type
          		+"&begin_date="+begin_date
          		+"&end_date="+end_date
      ...
      $('#exportTotaledExcel').click(function(){
		  ...
		  $.post('/bookingAirRouteReport/downloadExcelList',{customer_id:customer_id,date_type:date_type,type:type,begin_date:begin_date,end_date:end_date}, function(data){
