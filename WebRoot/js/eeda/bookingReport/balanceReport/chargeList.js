  ...
  $(document).ready(function() {
     ...
     $('.paDiv').css("height",windowHeight - headerHeight);
      var dataTable = eeda.dt({
         ...
         // ajax: "/bookingChargeBalanceReport/list",
	...
	$('#singleSearchBtn').click(function(){
	     ...
	     var url = "/bookingChargeBalanceReport/list?sp_id="+sp_id
			+"&order_export_date_begin_time="+order_export_date_begin_time
	        +"&order_export_date_end_time="+order_export_date_end_time;
	     dataTable.ajax.url(url).load(tableStyle);
	     
	   //合计字段
         $.post('bookingChargeBalanceReport/listTotal',{
       	  sp_id:sp_id,
       	  order_export_date_begin_time:order_export_date_begin_time,
       	  order_export_date_end_time:order_export_date_end_time
         },function(data){
     ...
     var searchData=function(){
        ...
        //合计字段
          ...
          */
          var url = "/bookingChargeBalanceReport/list?sp="+sp_id
      ...
      var excel_method = function(sp_id,begin_time,end_time){
		  $.post('/bookingChargeBalanceReport/downloadExcelList',{sp_id:sp_id,begin_time:begin_time,end_time:end_time}, function(data){
