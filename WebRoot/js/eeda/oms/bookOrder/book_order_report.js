...
$(document).ready(function() {
	...
	$('#printOceanWord').click(function(){
    	...
    	$.post('/bookOrderReport/printOceanWord', {order_id:order_id}, function(data){
    		if(data){
                window.open(data);
    		  }else{
	...
	$('#printOceanSI').click(function(){
		...
		if(alert!=''){
			...
			$('#pdfAlert').click();
		    	...
		    	var order_id = $("#order_id").val();
		    	$.post('/bookOrderReport/printOceanSI', {order_id:order_id}, function(data){
		    		if(data){
		                window.open(data);
		                $.post('/bookOrder/siflag', {order_id:order_id}, function(data){
		...
		if(alert!=''){
			...
			$('#pdfAlert').click();
		    	...
		    	var order_id = $("#order_id").val();
		    	$.post('/bookOrderReport/printOceanHBLSI', {order_id:order_id}, function(data){
		    		if(data){
		                window.open(data);
		                $.post('/bookOrder/siflag', {order_id:order_id}, function(data){
    ...
    $('#printOceanHBL,#prinTelextOceanHBL').click(function(){
		...
		if(alert!=''){
	    	...
	    	$.post('/bookOrderReport/printOceanHBL', {order_id:order_id,hbl_no:hbl_no,printHBL:printHBL}, function(data){
	    		if(data){
	                window.open(data);
	             }else{
    ...
    $('#printOceanBooking').click(function(){
    	...
    	if(alert!=''){
	    	...
	    	$.post('/bookOrderReport/printOceanBooking', {order_no:order_no}, function(data){
	    		if(data){
	    			window.open(data);
	    		}else{
...
//			   });
    ...
    $('#printOceanHead').click(function(){
		...
		$.post('/bookOrderReport/printOceanHead', {params:JSON.stringify(oceanHead)}, function(data){
    ...
    $('#oceanMBL').click(function(){
    	var order_id = $("#order_id").val();
    	$.post('/bookOrder/mblflag',{order_id:order_id},function(data){
    		if(data.result==true){
    ...
    $('#alreadyAFR_AMS').click(function(){
    	var order_id = $("#order_id").val();
    	$.post('/bookOrder/aframsflag',{order_id:order_id},function(data){
    		if(data.result==true){
    ...
    $('#alreadyInline').click(function(){
    	var order_id = $("#order_id").val();
    	$.post('/bookOrder/alreadyInlineFlag',{order_id:order_id},function(data){
    		if(data.result==true){
    ...
    $('#printAirBooking').click(function(){
    	    	...
    	    	if(alert!=''){
		    		...
		    		var order_no = $("#order_no").val();
		    		$.post('/bookOrderReport/printAirBooking', {order_no:order_no}, function(data){
		    			if(data){
		    				window.open(data);
		    			}else{
	    	...
	    	if(alert!=''){
				...
				$('#land_table input[type="checkbox"]').each(function(){
					...
					if(checkbox){
						...
						k++;
				    	$.post('/bookOrderReport/printTruckOrderPDF', {itemId:itemId}, function(data){
							if(data){
								 window.open(data);	
								 $.post('/bookOrder/truckOrderflag', {itemId:itemId,order_id:order_id}, function(data){
	...
	$('#printDebitNoteBtn').click(function(){
		$(this).attr('disabled', true);
	    	...
	    	var invoiceNo = $('#invoiceNo').val();
	    	 ...
	    	 $.post('/bookOrder/saveDebitNote', {itemIds:itemIdsStr,invoiceNo:invoiceNo}, function(data){
	    		 if(data.result==true){
			    	$.post('/bookOrderReport/printDebitNotePDF', {debit_note:debit_note, itemIds:itemIdsStr,order_no:order_no}, function(data){
	...
	$('#land_printDebit .btn-primary').click(function(){
		...
		$.post('/bookOrder/saveDebitNoteOfLand', {landIds:landIdsStr,invoice_land_hbl_no:invoice_land_hbl_no,land_ref_no:land_ref_no}, function(data){
			if(data.result==true){
				$.post('/bookOrderReport/printDebitNotePDF', {debit_note:'land_invoice', landIds:landIdsStr}, function(data){
    ...
    $('#printCabinetTruck').click(function(){
		...
		$('#land_table input[type="checkbox"]:checked').each(function(){
				...
				k++;
				$.post('/bookOrderReport/printCabinetTruck', {params:JSON.stringify(truckHead)}, function(data){
