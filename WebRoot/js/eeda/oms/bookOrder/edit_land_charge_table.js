...
$(document).ready(function() {
    ...
    $('#landcollapseChargeInfo').on('show.bs.collapse',function(){
        ...
        if(order_type.trim() == '' || customer_id == ''){
            ...
            $.post('/bookOrder/getLandArapTemplate', {order_type:order_type,customer_id:customer_id,arap_type:type}, function(data){
                if(data){
    ...
    $('#landChargeDiv,#landCostDiv').on('click','.deleteChargeTemplate,.deleteCostTemplate',function(){
        ...
        var id=ul.attr('id');
        $.post('/bookOrder/deleteLandArapTemplate',{id:id},function(data){
            if(data){
  ...
  //弹出此陆运相关的费用
    ...
    $('#land_charge_table_msg').on('click','.save',function(){
    	...
    	$.post('/bookOrder/saveLandCharge', {params:JSON.stringify(order)}, function(data){
    		 
    		 var url = "/bookOrder/tableListOfLandCharge?order_id="+order_id+"&land_item_id="+land_item_id;
    ...
    $('#land_table').on('click','.land_charge',function(){
            ...
            $("#land_charge_table").on('click', '.chargeConfirm', function(){
            	...
            	$.post('/bookOrder/feeConfirm',{id:id},function(data){
            		var url = "/bookOrder/tableListOfLandCharge?order_id="+order_id+"&land_item_id="+land_item_id;
                	chargeTable.ajax.url(url).load();
