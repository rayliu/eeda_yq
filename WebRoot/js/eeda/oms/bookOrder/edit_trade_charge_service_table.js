...
$(document).ready(function() {
    ...
    itemOrder.refleshTradeServiceItemTable = function(order_id){
    	var url = "/bookOrder/tableList?order_id="+order_id+"&type=trade_service";
    ...
    $('#collapseChargeServiceInfo').on('show.bs.collapse', function () {
        ...
        if(order_type.trim() == '' || customer_id == ''){
            ...
            $.post('/bookOrder/getTradeServiceTemplate', {order_type:order_type,customer_id:customer_id,arap_type:type}, function(data){
                if(data){
    ...
    $('#collapseChargeServiceInfo').on('click', '.deleteChargeTemplate,.deleteCostTemplate', function(){
        ...
        var id = ul.attr('id');
        $.post('/bookOrder/deleteTradeServiceTemplate', {id:id}, function(data){
            if(data){
