...
$(document).ready(function() {
	...
	var deletedTableIds=[];
    //删除一行
    $("#trade_cargo_table").on('click', '.delete', function(e){
        e.preventDefault();
    ...
    itemOrder.buildTradeCargoItem=function(){
        var cargo_table_rows = $("#trade_cargo_table tr");
    ...
    var cargoTable = eeda.dt({
	    ...
	    columns:[
            ...
            { "data": "CNY_DOMESTIC_PRICE", "width": "180px",
            	"render": function ( data, type, full, meta ) {
            		if(!data)
            			data='';
            ...
            { "data": "USD_PRICE", "width": "180px",
            	"render": function ( data, type, full, meta ) {
            		if(!data)
            			data='';
            		return '<input type="text" name="usd_price" value="'+data+'" class="form-control" style="width:200px"/>';
            	}
            },
            { "data": "USD_EXPORT_AMOUT", "width": "180px",
            	"render": function ( data, type, full, meta ) {
            		if(!data)
            			data='';
            		return '<input type="text" name="usd_export_amout" value="'+data+'" class="form-control" style="width:200px"/>';
            	}
            }
        ]
    });

    $('#add_trade_cargo_table').on('click', function(){
        var item={};
