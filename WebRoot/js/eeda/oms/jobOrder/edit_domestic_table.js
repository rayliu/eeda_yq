...
$(document).ready(function() {
	...
	var deletedTableIds=[];
    //删除一行
    $("#domestic_table").on('click', '.delete', function(e){
        e.preventDefault();
    ...
    //添加一行
    $('#add_domestic').on('click', function(){
        var item={};
        cargoTable.row.add(item).draw(true);
    });
    

    itemOrder.buildDomesticDetail=function(){
        var cargo_table_rows = $("#domestic_table tr");
    ...
    //------------事件处理
    var cargoTable = $('#domestic_table').DataTable({
        "processing": true,
        "searching": false,
        "paging": false,
        "info": false,
    ...
    itemOrder.refleshTable = function(order_id){
    	var url = "/jobOrder/tableList?order_id="+order_id+"&type=domestic";
