...
$(document).ready(function() {
    ...
    $("#charge_table").on('click', '.chargeConfirm', function(){
    	...
    	$.post('/bookingOrder/feeConfirm',{id:id},function(data){
    ...
    $("#charge_table").on('click', '.cancelChargeConfirm', function(){
    	var id = $(this).parent().parent().parent().attr('id');
    	$.post('/bookingOrder/feeCancelConfirm',{id:id},function(data){
    		if(data.BILL_FLAG == 'Y'){
   ...
   $(function(){
    ...
    itemOrder.refleshChargeTable = function(order_id){
    	var url = "/bookingOrder/tableList?order_id="+order_id+"&type=charge";
