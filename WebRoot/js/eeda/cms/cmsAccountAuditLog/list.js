define(['jquery', 'metisMenu', 'sb_admin',  'dataTablesBootstrap', 'validate_cn', 'sco', 'datetimepicker_CN'], function ($, metisMenu) {
    $(document).ready(function() {
        ...
        var accountAuditLogTable = eeda.dt({
            ...
            paging: true,
            serverSide: true, 
            ajax: "/cmsAccountAuditLog/list?beginTime="+$("#beginTime_filter").val(),
            columns:[
                {   "width":"30px",
        ...
        var accountTable = eeda.dt({
            ...
            paging: true,
            serverSide: true, 
            ajax: "/cmsAccountAuditLog/accountList?beginTime="+ $("#beginTime_filter").val(),
            columns:[
        ...
        $('#datetimepicker').datetimepicker({  
            ...
            $('#beginTime_filter').trigger('keyup');
       		...
       		var accoutUrl = "/cmsAccountAuditLog/accountList?beginTime="+beginTime;
       		accountTable.ajax.url(accoutUrl).load();
       		
       		var accountAuditLogUrl = "/cmsAccountAuditLog/list?ids="+ids+"&beginTime="+beginTime;
        ...
        $("#account-table").on('click', function(e){
        	var idArr=[];
       		...
       		var url= "/cmsAccountAuditLog/list?ids="+ids+"&beginTime="+beginTime;
        ...
        var find = function(){
        	...
        	var money = $('#money').val();
        	var url = "/cmsAccountAuditLog/list?source_order="+source_order
    										            +"&orderNo="+orderNo
    										            +"&bankName="+bankName
    										            +"&money="+money
    										            +"&begin="+beginTime
