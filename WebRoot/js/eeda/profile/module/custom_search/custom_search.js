define(['jquery', './custom_search_source', './custom_search_cols', './custom_search_filter'], 
  function ($, sourceCont, colCont, filterCont) {
        ...
        $('#custom_data_source_table tbody').on('click', 'tr', function (event) {
            current_tr = this;
            $('#custom_data_source_table tbody tr').css('background-color','#fff');
        ...
        $('#addInterfaceBtn').click(function(){
            ...
            current_tr = $('#custom_data_source_table tr:eq('+current_tr_index+')');
        });
