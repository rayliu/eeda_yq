...
define(['jquery'], function ($) {
       //表单赋值的对话框 --------------------
       $('#form_set_value_edit_condition_btn').click(function(event) {
            redisplay_conditions();
            $('#formular_condition_type').val('form_set_value');
       ...
       var li_html= '<li>'+
        ...
        $('#formular_condition_modal_ok_btn').click(function(){
            ...
            $('#form_set_value_sub_filter_condition').trigger('change');
            $('#formular_conditon_modal').modal('hide');
        });
        ...
        function build_condition_json(){
            ...
            //往动作配置的input 添加数据
            var condition_obj = {
                formular_conditon_match_type: $('#formular_conditon_match_type').val(),
                form_set_value_sub_filter_condition: desc_li_array
            }
            $('#form_set_value_sub_filter_condition').val(JSON.stringify(condition_obj));
        };

        function redisplay_conditions(){
            var condition_json=$('#form_set_value_sub_filter_condition').val();
            if(!condition_json) return;
            var condition_obj= JSON.parse(condition_json);
            var formular_conditon_match_type = condition_obj.formular_conditon_match_type;
            $('#formular_conditon_match_type').val(formular_conditon_match_type);
            var condition_obj_array = condition_obj.form_set_value_sub_filter_condition;
