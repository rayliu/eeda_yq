       ...
       var li_html= '<li>'+
        ...
        function build_condition_json(){
            ...
            for (let i = 0; i < desc_li_list.length; i++) {
                ...
                var item={
                    condition_field1_type:desc_li.find('.condition_field1_type_desc').text(),
                    condition_field1:desc_li.find('.condition_field1_desc').text(),
                    condition_operator:desc_li.find('.condition_operator_desc').text(),
                    condition_field2_type:desc_li.find('.condition_field2_type_desc').text(),
                    condition_field2:desc_li.find('.condition_field2_desc').text()
                }
        ...
        function redisplay_conditions(condition_json){
