...
$(document).ready(function() {
    ...
    $("#doc_table").on('click', '.delete', function(e){
        ...
        var id = tr.attr('id');
         ...
         $.post('/serviceProvider/deleteDoc', {docId:id}, function(data){
        	 if(data.result==true){
    ...
    var refleshDocTable = function(order_id){
    	var url = "/serviceProvider/tableList?order_id="+order_id+"&type=docItem";
	...
	$('#fileupload').click(function(){
		...
		$('#fileupload').fileupload({
				autoUpload: true, 
			    url: '/serviceProvider/saveDocFile?order_id='+order_id,
			    dataType: 'json',
