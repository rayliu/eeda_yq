	...
	$(document).ready(function() {
	    ...
	    itemOrder.buildDockItem=function(){
	        ...
	        for(var index=0; index<cargo_table_rows.length; index++){
	            ...
	            var item={}
	            item.id = id;
	            item.party_type = 'serviceProvider';
	            	...
	            	"render": function ( data, type, full, meta ) {
	            		if(full.ID){
	            			if(data){
		            			...
		            			return '<span class="fileinput-button btn table_btn btn_green btn-xs  upload" style="width:100%" title="请先保存再上传文件">' 
	    ...
	    itemOrder.refleshTable = function(order_id){
	    	var url = "/serviceProvider/tableList?order_id="+order_id+"&type=dock";
